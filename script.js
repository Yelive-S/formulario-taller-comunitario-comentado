...
function limpiarErrores() {
    ...
    nombre.classList.remove("campo-invalido", "campo-valido");
    correo.classList.remove("campo-invalido", "campo-valido");
    edad.classList.remove("campo-invalido", "campo-valido");
    contacto.classList.remove("campo-invalido", "campo-valido");
    taller.classList.remove("campo-invalido", "campo-valido");
    mensaje.classList.remove("campo-invalido", "campo-valido");

    mensajeGeneral.textContent = "";
    mensajeGeneral.classList.remove("error", "exito");
